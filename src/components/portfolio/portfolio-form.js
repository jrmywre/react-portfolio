...
export default class PortfolioForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      logo: "",
      editMode: false,
      apiUrl: "https://jeremyware.devcamp.space/portfolio/portfolio_items",
      apiAction: "post"
    };
  ...
  deleteImage(imageType) {
    ...
    { withCredentials: true }
      ...
      consolse.log("deleteImage error", error)
    })
  }
  ...
  componentDidUpdate() {
    if (Object.keys(this.props.portfolioToEdit).length > 0) {
      ...
      this.setState({
        ...
        url: url || "",
        editMode: true,
        apiUrl: `https://jeremyware.devcamp.space/portfolio/portfolio_items/${id}`,
        apiAction: "patch",
